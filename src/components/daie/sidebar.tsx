...
export function Sidebar({ user, onboardingComplete }: { user: CurrentUser; onboardingComplete: boolean | null }) {
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-64 shrink-0 flex-col bg-sidebar-background text-sidebar-foreground">
      ...
      <div className="border-t border-white/10 px-6 py-3 text-center text-[11px] font-medium tracking-wide text-white/40">
        Built by Kausar Tech
      </div>
    </aside>
  );
}
